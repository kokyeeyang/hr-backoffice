...
class AdminIdentity extends CUserIdentity
{
	...
	{
		$objAdmin = Admin::model()->find('LOWER(admin_email_address)=:admin_email_address AND admin_status=:admin_status', array(':admin_email_address' => strtolower($this->username), ':admin_status'=> Admin::ACTIVE));
		...
		if($objAdmin === null){
			...
			if(isset($objAdmin->admin_password) && $objAdmin->admin_password === sha1($this->password)){
				...
				$this->username		= $objAdmin->admin_email_address;
