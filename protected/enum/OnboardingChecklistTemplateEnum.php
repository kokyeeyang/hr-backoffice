...
class OnboardingChecklistTemplateEnum {
	const ONBOARDING_CHECKLIST_TEMPLATE = "Onboarding Checklist Template";
	const ONBOARDING_CHECKLIST_TEMPLATE_TABLE = "OnboardingChecklistTemplate";
