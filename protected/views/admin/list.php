<div class="breadcrumb">
	<div class="breadcrumb_wrapper">
		<div class="breadcrumb-top"><?php echo Yii::t('app', 'Admin User Management') . ' - ' . Yii::t('app', 'List'); ?></div>
		<div class="breadcrumb-bottom breadcrumb-bottom-key">
			<div class="title">
				<span><?php echo Yii::t('app', 'Admin Users List'); ?></span>
			</div>
		</div>
	</div>
</div>
<div class="common_content_wrapper admin_list">
	<div class="common_content_inner_wrapper">
		<h4 class="widget_title"><?php echo Yii::t('app', 'Admin Users List'); ?></h4>
		<?php 
		...
		<table class="widget_table grid">		
			<thead>
				<tr>
					...
					<th>
						<div class="btnAjaxSortList sort_wrapper<?php if($strSortKey === 'sort_modified_datetime_desc'){?> desc<?php }elseif($strSortKey === 'sort_modified_datetime_asc'){ ?> asc<?php } ?>" rel="sort" rev="sort_modified_datetime">
							<a title="<?php echo Yii::t('app', 'Sort'); ?>" href="javascript:void(0);">
								<div class="sort_wrapper_inner">								
									<div class="sort_label_wrapper">
										<div class="sort_label"><?php echo Yii::t('app', 'Modified Datetime'); ?></div>
									</div>
									<div class="sort_icon_wrapper">
										<div class="sort_icon">&nbsp;</div>
									</div>
			...
			<?php
				...
				<tr>
					...
					<td><?php echo $objRecord -> admin_modified_datetime; ?></td>
