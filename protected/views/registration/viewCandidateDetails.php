                ...
                <fieldset class="fieldset">
                    ...
                    <div class="buttons" style="margin-left: 400px; margin-right: 50px; width: 40%; border-left: 50px; text-align: center;">
                        ...
                        <div class="lable_block" id="offer_letter_button">
                            ...
                            <input id="generateOnboardingChecklist" data-generate-onboarding-url="<?php echo $this->createUrl('onboarding/actionAssignOnboardingChecklistItems', array('candidateId' => $candidateObjRecord->id_no)); ?>" style="display:none;">
                        </div>
...
<div id="registration-common-msg">
    <div id="msg-generate-template" data-msg="<?php echo Yii::t('app', 'Are you sure that you want to generate template and user access for this user?'); ?>"></div>
</div>
