                ...
                <fieldset class="fieldset">
                    ...
                    <div class="buttons" style="margin-left: 400px; margin-right: 50px; width: 40%; border-left: 50px; text-align: center;">
                        ...
                        <div class="lable_block" id="offer_letter_button">
                            ...
                            <input id="generateOnboardingChecklistTemplate" data-generate-onboarding-url="<?php echo $this->createUrl('registration/assignItemsAndUserAccess', array('candidateId' => $candidateArrRecords['id_no'], 'departmentId'=>$candidateArrRecords['department'], 'fullName'=>$candidateArrRecords['full_name'], 'isManagerial'=>$candidateArrRecords['is_managerial_position'])); ?>" style="display:none;">
                        </div>
