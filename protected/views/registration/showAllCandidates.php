			...
			<tbody id="data_table">
				...
				?>
					<tr>
						...
						<td>
							<select name="position-dropdown" size=1 class="changeCandidatePosition" data-change-url="<?php echo $this->createUrl('registration/changeCandidatePosition', array('candidateId' => $objRecord->id_no)); ?>" title="Select here if you would like to change this candidate's applied for job">
