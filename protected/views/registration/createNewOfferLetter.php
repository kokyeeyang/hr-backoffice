	    		...
	    		<textarea id="basic-example">
					  <p style="text-align: left; margin:40px;">
						...
						<p style="text-align: left; margin:40px;">
							...
							<br/><br/>
							LETTER OF APPOINTMENT - %%Candidate name%%
							<br/>
						</p>
						<p style="margin:40px;">
							We are pleased to offer you employment as Online Customer Support Agent with SAGAOS SDN. BHD. (herein after referred to as "the Company") with effect from <?php echo $dateToday; ?>.
							<br/><br/>
							...
							<div style="padding-left:60px;"><b> 9)Public Holidays </b></div>
